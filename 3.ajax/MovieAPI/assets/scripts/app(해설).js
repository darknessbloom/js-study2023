...
//     console.log($editLi);
//     const $editSpan = $editLi.querySelector(".checkbox span");
//     const originText = $editSpan.textContent;
//     const $newedit = document.createElement("input");
//     $newedit.value = originText;
//     $newedit.setAttribute("class", "text");
//     $newedit.classList.add("modify-input");
//     // $newedit.classList.add('modify-input:focus');
...
//       text: text,
//     };
//     fetchTodos(`${URL}/${id}`, "PATCH", payload).then((res) => {
//       if (res.status === 200 || res.status === 201) {
//         alert("수정 성공!");
//       } else {
//         alert("수정 실패!");
